...
Docker based local environment that can be combined with https://github.com/mariolorenz/docker-eshop-sdk-recipes for OXID eShop development.
...
```
git clone https://github.com/mariolorenz/docker-eshop-sdk.git myProjectName
cd myProjectName
